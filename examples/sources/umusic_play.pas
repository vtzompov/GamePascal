...
const
  cWindowTitle  = 'Music: Play';

var
  Music: Integer = AUDIO_ERROR;
...
begin
  ...
  case aType of
    ...
    begin
      ...
      // load music
      Music := AudioLoadMusic(Archive, 'arc/music/song13.ogg');

      // start music playing at full volume and loop
      AudioPlayMusic(Music, 1.0, True);
    end;
