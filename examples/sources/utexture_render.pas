...
begin
  ...
  case aType of
    ...
    begin
      ...
      // load new texture
      Texture := TextureNewLoad(Archive, 'arc/images/GPT2.png', nil);
    ...
    begin
      // render texture
      TextureRender(Texture, nil, WINDOW_WIDTH/2, WINDOW_HEIGHT/2, 1, 0, fmNone, 0.5, 0.5, WHITE, bmBlend);
    end;
