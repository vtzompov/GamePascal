...
const
  cWindowTitle  = 'Texture: Tiled';

var
  Texture: TTexture = nil;
  Pos: TPoint;
...
begin
  ...
  case aType of
    ...
    begin
      ...
      // load texture
      Texture := TextureNewLoad(Archive, 'arc/images/bluestone.png', nil);

      // init texture offset position
      Pos.X := 0;
      Pos.Y := 0;
    ...
    begin
      ...
      Pos.Y := Pos.Y + (30.0 * aParam.geUpdate_DeltaTime);
    end;
    ...
    geRender:
    begin
      // tile texture across the viewport
      TextureRenderTiled(Texture, Pos.X, Pos.Y, WHITE, bmNone);
    end;
